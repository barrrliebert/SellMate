                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-6 p-4 bg-white dark:bg-gray-900 rounded-lg border border-[#D4A8EF]">
                            <label className="text-2xl font-semibold text-gray-900 dark:text-gray-300">
                                Informasi Video
                            </label>
                    ...
                    <div className="mt-6 flex justify-end">
                        <button
                            type="submit"
                            disabled={processing}
                            className="bg-[#AA51DF] hover:bg-indigo-700 disabled:opacity-50 px-8 py-2 rounded-md text-white"
                        >
                            Simpan Perubahan
                        </button>
                    </div>
