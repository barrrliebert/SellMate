        ...
        <main>
            <div className='min-h-screen flex overflow-y-auto'>
                ...
                <div className='flex-1 flex-col overflow-y-auto h-screen'>
                    ...
                    <div className='w-full py-8 px-4 md:px-6 min-h-screen overflow-y-auto mb-14 md:mb-0 text-white bg-white lg:bg-transparent dark:bg-gray-950 dark:text-gray-100'>
